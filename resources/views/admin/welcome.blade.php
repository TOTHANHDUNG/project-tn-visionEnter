        ...
        <div class="row">
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box">
              ...
              <div class="info-box-content">
                <span class="info-box-text">Thống kê thành viên </span>
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                <span class="info-box-text">Thống kê người dùng</span>
                <span class="info-box-number">{{$allaccountuser}}</span>
              </div>
              <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                <span class="info-box-text">Thống kê quản trị viên</span>
                <span class="info-box-number">{{$allaccountadmin}}</span>
              </div>
              <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box">
              ...
              <div class="info-box-content">
                <span class="info-box-text">Thống kê khóa học</span>
                <span class="info-box-number">
                  {{$allcourse}}
                  <small>Orang</small>
                </span>
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box">
              ...
              <div class="info-box-content">
                <span class="info-box-text">Khóa học Tiếng Anh </span>
                <span class="info-box-number">
                  {{$courseenglish}}
                  <small>Orang</small>
                </span>
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box">
              ...
              <div class="info-box-content">
                <span class="info-box-text">Khóa học Tiếng Hàn </span>
                <span class="info-box-number">
                  {{$coursekorean}}
                  <small>Orang</small>
                </span>
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box">
              ...
              <div class="info-box-content">
                <span class="info-box-text">Thống kê giáo viên</span>
                <span class="info-box-number">
                  {{$allteacher}}
                  <small>Orang</small>
                </span>
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box">
              ...
              <div class="info-box-content">
                <span class="info-box-text">Giáo viên Tiếng Anh </span>
                <span class="info-box-number">
                  {{$teacherenglish}}
                  <small>Orang</small>
                </span>
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box">
              ...
              <div class="info-box-content">
                <span class="info-box-text">Giáo viên Tiếng Hàn </span>
                <span class="info-box-number">
                  {{$teacherkorean}}
                  <small>Orang</small>
                </span>
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box">
              ...
              <div class="info-box-content">
                <span class="info-box-text">Giáo viên mới </span>
                <span class="info-box-number">
                  2,000
                  <small>Orang</small>
                </span>
