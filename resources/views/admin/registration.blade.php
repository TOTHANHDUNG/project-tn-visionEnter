...
@section('content')
    <div class="container">
        <div class="mt-5">
            <div class="col-12 col-md-6 ms-auto me-auto registration-container">
                <form action="{{ route('registration.post') }}" method="POST" class="ms-auto me-auto">
                    ...
                    <div class="mb-3 mt-3">
                        ...
                        <input type="text" class="form-control" required name="name" placeholder="To Thanh Dung">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="password" class="form-control" required name="password" placeholder="Tối thiếu là 6 ký tự">
                    </div>

                    <button type="submit" class="btn btn-primary mt-2">Đăng ký</button>
                    <div class=" justify-content-center align-items-center mt-3">
                        <div id="loginLink" class="form-text text-center">
                            <span>Đã có tài khoản?</span>
                        </div>
                        <button type="submit" class="btn btn-login-with-register mt-2"><a href="/login"> Đăng nhập</a></button>
                    </div>
                </form>
            </div>
        </div>
